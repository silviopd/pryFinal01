 ...
 * @author USER
 */
public class frmInsumoBuscar extends javax.swing.JDialog {

    private ResultSet resultado;    
    public String datosBuscar = "";
    public int valorRetorno1=0;

    public frmInsumoBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void cargarDatosConsulta() {
        try {
            resultado = new articulo().listarInsumo();
        } catch (Exception e) {
