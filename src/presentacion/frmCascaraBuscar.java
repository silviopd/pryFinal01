 ...
 * @author USER
 */
public class frmCascaraBuscar extends javax.swing.JDialog {

    private ResultSet resultado;    
    public String datosBuscar = "";
    public int valorRetorno1=0;

    public frmCascaraBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void cargarDatosConsulta() {
        try {
            resultado = new articulo().listarCascara();
        } catch (Exception e) {
    ...
    private void filtrar() {
        try {
            int anchoColumnas[] = {80, 300};
            String alinearColumnas[] = {"C", "I"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Cascara");
