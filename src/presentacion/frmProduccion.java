...
import negocio.produccion_cascara;
import negocio.produccion_insumo;
...
//    private ResultSet resultado;
    ...
    public frmProduccion(java.awt.Frame parent, boolean modal) {
        ...
        configurarCabeceraInsumo();
        configurarCabeceraCascara();
...
//        txtNumeroSerie.requestFocus();
    ...
    private boolean validarDatos() {
        ...
        if (cboTipoComprobante.getSelectedItem().toString().isEmpty()) {
            ...
            Funciones.mensajeAdvertencia("Debe ingresar un codigo", "Verifique");
            ...
            Funciones.mensajeAdvertencia("Debe agregar articulos para produccion", "Verifique");
            return false;
        }else if (tblCascara.getRowCount() <= 0) {
            Funciones.mensajeAdvertencia("Debe agregar articulos para cascara", "Verifique");
            return false;
        }else if (tblInsumo.getRowCount() <= 0) {
            Funciones.mensajeAdvertencia("Debe agregar articulos para insumo", "Verifique");
            return false;
        }
...
//        }
    ...
    public void calcularPromedioHumedad() {
        
        double humedad=0,promedio_humedad=0,numero=0;
        for (int i = 0; i < tblCascara.getRowCount(); i++) {
            humedad = Double.parseDouble(tblCascara.getValueAt(i, 3).toString().replace(",", ""));            
            promedio_humedad=(promedio_humedad+humedad);            
            numero=i;
        }
            promedio_humedad=promedio_humedad/(numero+1);
            lblHumedad.setText(Funciones.formatearNumero(promedio_humedad));
    }
    
    public void calcularImporteInsumo() {
        
        double sub_total=0,total=0;
        for (int i = 0; i < tblInsumo.getRowCount(); i++) {
            sub_total = Double.parseDouble(tblInsumo.getValueAt(i, 4).toString().replace(",", ""));
            total=total+sub_total;
        }
        lblInsumo.setText(Funciones.formatearNumero(total));
    }
//
...
//
    private void configurarCabeceraDetalleCompra() {
        try {
            ...
            int anchoCol[] = {80, 400, 80, 80, 80, 80, 80, 80,400, 80, 80,80};
            String alineCol[] = {"C", "I", "D", "D", "D", "D", "D", "D","I", "D", "D","D"};
    ...
    private void configurarCabeceraInsumo() {
        try {
            ResultSet resultado = new produccionDetalle().configurarTablaInsumo();
            int anchoCol[] = {80, 400, 80, 80,80};
            String alineCol[] = {"C", "I", "D", "D","D"};
            Funciones.llenarTabla(tblInsumo, resultado, anchoCol, alineCol);
        } catch (Exception e) {
            Funciones.mensajeInformacion(e.getMessage(), "ERROR...");
        }
    }
    
    private void configurarCabeceraCascara() {
        try {
            ResultSet resultado = new produccionDetalle().configurarTablaCascara();
            int anchoCol[] = {80, 400, 80, 80};
            String alineCol[] = {"C", "I", "D", "D"};
            Funciones.llenarTabla(tblCascara, resultado, anchoCol, alineCol);
        } catch (Exception e) {
            Funciones.mensajeInformacion(e.getMessage(), "ERROR...");
        }
    }
    ...
    private void initComponents() {
        ...
        lblImportePilado2 = new javax.swing.JTextField();
        ...
        final DefaultCellEditor edit1 = new DefaultCellEditor(field1);
        field1.setBorder(BorderFactory.createMatteBorder(3,3,3,3,Color.red));
        field1.setForeground(Color.blue);
        /*parte 1*/
        tblCascara = new javax.swing.JTable(){
            /*parte 2*/
            public boolean isCellEditable(int fila, int columna){
            ...
            public TableCellEditor getCellEditor(int row, int col) {
                if (col == 2){
                    field1.setDocument(new util.ValidaNumeros());
                }else{
                    field1.setDocument(new util.ValidaNumeros(util.ValidaNumeros.ACEPTA_DECIMAL));
                }
                edit1.setClickCountToStart(2);
        ...
        lblHumedad = new javax.swing.JTextField();
        ...
        field2.setBorder(BorderFactory.createMatteBorder(3,3,3,3,Color.red));
        ...
        lblInsumo = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        btnAgregar3 = new javax.swing.JButton();
        btnQuitar3 = new javax.swing.JButton();

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Artículos registrados de la compra"));
        ...
        tblCompra2.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tblCompra2PropertyChange(evt);
            }
        });
        tblCompra2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblCompra2KeyPressed(evt);
            }
        });
        jScrollPane3.setViewportView(tblCompra2);
        /*parte 3*/
        ...
        lblImportePilado2.setEditable(false);
        lblImportePilado2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblImportePilado2.setForeground(new java.awt.Color(255, 51, 51));
        lblImportePilado2.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        lblImportePilado2.setText("0.00");

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setText("Total importe pilados");

        btnAgregar2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnAgregar2.setText("Agregar artículo");
        ...
        btnQuitar2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnQuitar2.setText("Quitar artículo");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnQuitar2, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
                        .addComponent(jLabel12)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblImportePilado2, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel12)
                    .addComponent(lblImportePilado2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Cascara"));

        tblCascara.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblCascara.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tblCascaraPropertyChange(evt);
            }
        });
        tblCascara.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblCascaraKeyPressed(evt);
            }
        });
        jScrollPane2.setViewportView(tblCascara);
        /*parte 3*/
        tblCascara.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                field1.setText("");
        ...
        lblHumedad.setEditable(false);
        lblHumedad.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblHumedad.setForeground(new java.awt.Color(255, 51, 51));
        lblHumedad.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        lblHumedad.setText("0.00");

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Total humedad promedio");

        btnAgregar1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnAgregar1.setText("Agregar cascara");
        ...
        btnQuitar1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnQuitar1.setText("Quitar cascara");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnQuitar1, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 90, Short.MAX_VALUE)
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblHumedad, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel10)
                    .addComponent(lblHumedad, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        tblInsumo.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tblInsumoPropertyChange(evt);
            }
        });
        tblInsumo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblInsumoKeyPressed(evt);
            }
        });
        jScrollPane4.setViewportView(tblInsumo);
        /*parte 3*/
        tblInsumo.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                field2.setText("");
        ...
        lblInsumo.setEditable(false);
        lblInsumo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblInsumo.setForeground(new java.awt.Color(255, 51, 51));
        lblInsumo.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        lblInsumo.setText("0.00");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setText("Total insumos");

        btnAgregar3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnAgregar3.setText("Agregar insumo");
        ...
        btnQuitar3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnQuitar3.setText("Quitar insumo");
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnQuitar3, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 90, Short.MAX_VALUE)
                        .addComponent(jLabel13)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblInsumo, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnAgregar3, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnQuitar3)
                    .addComponent(jLabel13)
                    .addComponent(lblInsumo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (obj.valorRetorno1 > 0) {
            ...
            Object filaDatos[] = new Object[12];
...
//        calcularTotales();
    ...
    private void tblCascaraPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tblCascaraPropertyChange
        if (evt.getPropertyName().equalsIgnoreCase("tableCellEditor")) {
            //System.out.println("Editando datos sobre la tabla");
            int columnaEditar = this.tblCascara.getEditingColumn();

            if (columnaEditar == 2 || columnaEditar == 3) {

                calcularPromedioHumedad();
            }
        }
    }//GEN-LAST:event_tblCascaraPropertyChange

    private void tblCascaraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblCascaraKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tblCascaraKeyPressed

    private void btnAgregar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregar1ActionPerformed
        frmCascaraBuscar obj = new frmCascaraBuscar(null, true);
        obj.setVisible(true);

        if (obj.valorRetorno1 > 0) {
            int filasel = obj.tblListado.getSelectedRow();
            
            int codigoCascara = Integer.parseInt(obj.tblListado.getValueAt(filasel, 0).toString());
            String nombreCascara = obj.tblListado.getValueAt(filasel, 1).toString();
            int cantidadSacos = 0;            
            double humedad = 0;
            

            DefaultTableModel modelo = (DefaultTableModel) this.tblCascara.getModel();

            Object filaDatos[] = new Object[4];
            filaDatos[0] = codigoCascara;
            filaDatos[1] = nombreCascara;
            filaDatos[2] = cantidadSacos;
            filaDatos[3] = humedad;

            modelo.addRow(filaDatos);

            tblCascara.setModel(modelo);
        }
    }//GEN-LAST:event_btnAgregar1ActionPerformed

    private void btnQuitar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitar1ActionPerformed
        DefaultTableModel tablaDetalle
                = (DefaultTableModel) this.tblCascara.getModel();

        int fila = this.tblCascara.getSelectedRow();
        ...
        String articulo = tblCascara.getValueAt(fila, 1).toString();
        int respuesta = Funciones.mensajeConfirmacion(
                "Esta seguro de quitar el artículo: " + articulo,
                "Confirme"
        );
        ...
        tablaDetalle.removeRow(fila);
        this.tblCascara.setModel(tablaDetalle);

//        calcularTotales();
    }//GEN-LAST:event_btnQuitar1ActionPerformed

    private void tblInsumoPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tblInsumoPropertyChange
       if (evt.getPropertyName().equalsIgnoreCase("tableCellEditor")) {
            //System.out.println("Editando datos sobre la tabla");
            int columnaEditar = this.tblInsumo.getEditingColumn();
            int filaEditar = this.tblInsumo.getEditingRow();
            
            if (columnaEditar == 2 || columnaEditar == 3) {

                int cantidad = Integer.parseInt(this.tblInsumo.getValueAt(filaEditar, 2).toString());
                double precio = Double.parseDouble(this.tblInsumo.getValueAt(filaEditar, 3).toString());
                double importe=cantidad*precio;
                this.tblInsumo.setValueAt(Funciones.formatearNumero(importe), filaEditar, 4);
                
                calcularImporteInsumo();
            }
        }
    }//GEN-LAST:event_tblInsumoPropertyChange

    private void tblInsumoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblInsumoKeyPressed

    }//GEN-LAST:event_tblInsumoKeyPressed

    private void btnAgregar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregar3ActionPerformed
        frmInsumoBuscar obj = new frmInsumoBuscar(null, true);
        obj.setVisible(true);

        if (obj.valorRetorno1 > 0) {
            int filasel = obj.tblListado.getSelectedRow();
            
            int codigoInsumo = Integer.parseInt(obj.tblListado.getValueAt(filasel, 0).toString());
            String nombreInsumo = obj.tblListado.getValueAt(filasel, 1).toString();
            int cantidad = 0;
            double precioInsumo = Double.parseDouble(obj.tblListado.getValueAt(filasel, 2).toString());            
            double importe = 0;
            

            DefaultTableModel modelo = (DefaultTableModel) this.tblInsumo.getModel();

            Object filaDatos[] = new Object[5];
            filaDatos[0] = codigoInsumo;
            filaDatos[1] = nombreInsumo;
            filaDatos[2] = cantidad;
            filaDatos[3] = precioInsumo;
            filaDatos[4] = importe;

            modelo.addRow(filaDatos);

            tblInsumo.setModel(modelo);
        }
    }//GEN-LAST:event_btnAgregar3ActionPerformed

    private void btnQuitar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitar3ActionPerformed
        DefaultTableModel tablaDetalle
                = (DefaultTableModel) this.tblInsumo.getModel();
        ...
        String articulo = tblInsumo.getValueAt(fila, 1).toString();
        int respuesta = Funciones.mensajeConfirmacion(
                "Esta seguro de quitar el artículo: " + articulo,
                "Confirme"
        );
        ...
        tablaDetalle.removeRow(fila);
        this.tblInsumo.setModel(tablaDetalle);
...
//        calcularTotales();
    ...
    private void tblCompra2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblCompra2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tblCompra2KeyPressed

    private void tblCompra2PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tblCompra2PropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_tblCompra2PropertyChange
    ...
    private void grabarCompra() {
        ...
        try {
            ...
            int codigo_sucursal = sucursal.listaTipoComp.get(cboTipoComprobante.getSelectedIndex()).getCodigo();            
            int cantidad_sacos_arroz_cascara=0;          
            ...
            double humedad_promedio=Double.parseDouble(lblHumedad.getText().replace(",", ""));
            double total_insumos=Double.parseDouble(lblInsumo.getText().replace(",", ""));;
            
            produccion objCompra = new produccion();
            objCompra.setCantidad_sacos_arroz_cascara(cantidad_sacos_arroz_cascara);
            objCompra.setFecha(fecha_compra);
            objCompra.setCodigo_sucursal(codigo_sucursal);
            objCompra.setCodigo_cliente(codigoCliente);
            objCompra.setTotal_pilado(total_pilado);
            objCompra.setTotal_envases(total_envases);
            objCompra.setHumedad_promedio(humedad_promedio);
            objCompra.setTotal_insumos(total_insumos);
            ...
            ArrayList<produccion_cascara> articuloDetalleCascara = new ArrayList<produccion_cascara>();
            for (int i = 0; i < tblCascara.getRowCount(); i++) {
                
                int codigo_cascara = Integer.parseInt(tblCascara.getValueAt(i, 0).toString());
                int cantidad_sacos = Integer.parseInt(tblCascara.getValueAt(i, 2).toString());
                double porcentaje_humedad = Double.parseDouble(tblCascara.getValueAt(i, 3).toString());
                
                produccion_cascara objFila = new produccion_cascara();
                objFila.setCantidad_sacos(cantidad_sacos);
                objFila.setCodigo_cascara(codigo_cascara);
                objFila.setPorcentaje_humedad(porcentaje_humedad);
                articuloDetalleCascara.add(objFila);
            }
            
            
            ArrayList<produccion_insumo> articuloDetalleInsumo = new ArrayList<produccion_insumo>();
            for (int i = 0; i < tblInsumo.getRowCount(); i++) {
                
                int codigo_insumo = Integer.parseInt(tblInsumo.getValueAt(i, 0).toString());
                int cantidad = Integer.parseInt(tblInsumo.getValueAt(i, 2).toString());
                double precio = Double.parseDouble(tblInsumo.getValueAt(i, 3).toString());
                
                produccion_insumo objFila = new produccion_insumo();
                objFila.setCantidad(cantidad);
                objFila.setCodigo_insumo(codigo_insumo);
                objFila.setPrecio(precio);
                articuloDetalleInsumo.add(objFila);
            }
            
            objCompra.setArticuloDetalleCompra(articuloDetalleCompra);
            objCompra.setArticuloProduccionCascara(articuloDetalleCascara);
            objCompra.setArticuloProduccionInsumo(articuloDetalleInsumo);
    ...
    private javax.swing.JTextField lblHumedad;
    private javax.swing.JTextField lblImporteEnvase;
    private javax.swing.JTextField lblImportePilado;
    private javax.swing.JTextField lblImportePilado2;
    private javax.swing.JTextField lblInsumo;
    private javax.swing.JTable tblCascara;
